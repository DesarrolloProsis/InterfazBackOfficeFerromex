  ...
  <div class="container mx-auto px-0 pb-2 pt-4">    
    <div class="flex flex-wrap ferromex-color p-1 rounded-lg">
      <div class="flex-none my-auto text-white font-md p-2 ml-1">
        Día:<input v-model="nombre" type="date" class="rounded text-black ml-2 md:w-20 2xl:w-20"/>
      </div>
      <div class="flex-none my-auto text-white font-md p-2 ml-1">
        Mes:<input v-model="nombre" type="month" class="rounded text-black ml-2 md:w-20 2xl:w-20"/>
      </div>
      <div class="flex-none my-auto text-white font-md p-2 ml-1">
        Semana:<input v-model="nombre" type="week" class="rounded text-black ml-2 md:w-20 2xl:w-20"/>
      </div>
      <div class="flex-none my-auto text-white font-md p-2 ml-1">
        Nombre:<input v-model="nombre" type="text" class="rounded ml-2 text-black 2xl:w-20" />
      </div>
      <div class="flex-none my-auto text-white font-md p-2 ml-1">
        Perfil:
        <select v-model="numRespuesta" class="rounded ml-2 text-black 2xl:w-20">
          <option :value="undefined" >Seleccione un Perfil</option>
          <option value="10">Perfil 1</option>
          <option value="30">Perfil 2</option>
          <option value="50">Perfil 3</option>
        </select>
      </div>
      <div class="flex-none my-auto text-white font-md p-2 ml-1">
        Acción:
        <select v-model="numRespuesta" class="rounded ml-2 text-black 2xl:w-20">
          <option :value="undefined" >Seleccione una Acción</option>
          <option value="10">Editar</option>
          <option value="30">Activar</option>
          <option value="50">Desactivar</option>
        </select>
      </div>
      <div class="hidden flex-none my-auto text-white font-md p-2">
        Estatus:  
      ...
      <div class="flex-none my-auto text-white font-md p-2 ml-1">
        <button @click="todos()" class="btn-buscar animacion">Descargar</button>
      </div>
      <div class="hidden flex-none my-auto text-white font-md p-2 md:ml-32 ">
